...
<li>{{ trans('breadcrumb.monthly-summary-single2') }}</li>
@endsection
...
<div class="portlet light portlet-fit portlet-datatable bordered">
	<div class="portlet-title">
      ...
      <span class="caption-subject font-green sbold uppercase"> {{ trans('breadcrumb.monthly-summary-single2') }} </span>
    </div>
    <div class="actions">
    	<a href="/olympic-salon/monthly-single-employee2/export?monthly_select_id={{$monthly_select_id}}&employee_id={{$employee_id}}" class="btn green">Export</a>
    </div>
	</div>
	<div class="portlet-body">
		<form method="GET" class="form-horizontal" role="form" action="{{ url($shop_url . '/monthly-single-employee2') }}">
			<div class="row">
...
<script src="/assets/pages/scripts/page-monthly-single2.js" type="text/javascript"></script>
